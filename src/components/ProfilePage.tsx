            ...
            <CardContent className="profile-mobile-card flex flex-col items-center space-y-3 sm:space-y-4">
              <div className="relative">
                ...
                <label
                  ...
                  className="absolute -bottom-2 -right-2 bg-primary text-primary-foreground p-3 rounded-full cursor-pointer hover:bg-primary/90 transition-colors shadow-lg"
                >
